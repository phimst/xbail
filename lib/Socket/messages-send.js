...
const { globalRateLimiter } = require('../Features/rate-limiter');
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            // ── rate limiter: throttle sebelum kirim ─────────────────────
            if (!options.skipRateLimit) {
                await globalRateLimiter.throttle(jid);
                globalRateLimiter.record(jid);
            }
