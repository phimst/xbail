...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    countryCode: "US",
    /**
     * clientType: 'default' | 'business' | 'messenger'
     * - 'business'  → browser agent WA Business
     * - 'messenger' → browser agent WA standard
     * - 'default'   → Chrome (default)
     */
    clientType: "default",
    /**
     * enableBuiltinCommands: true → aktifkan .baileys .eval .mesinfo
     * false → matikan semua built-in command
     */
    enableBuiltinCommands: true,
    /**
     * lidDbMigrated: true agar behavior natural seperti WA client resmi
     * set false jika ada masalah kompatibilitas
     */
    lidDbMigrated: true,
    getMessage: async () => { },
