...
const generateMessageID = () => {
    // Format mirip WA asli: 3A + random hex uppercase
    const prefix = ['3A', '3E', '3E', '28', '3A'][Math.floor(Math.random() * 5)];
    return prefix + (0, crypto_1.randomBytes)(9).toString('hex').toUpperCase();
};
