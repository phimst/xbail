...
const generateLoginNode = (userJid, config) => {
    ...
    // lidDbMigrated: true agar behavior lebih natural seperti WA client resmi
    // bisa di-override via config.lidDbMigrated = false jika ada masalah
    const lidDbMigrated = (config === null || config === void 0 ? void 0 : config.lidDbMigrated) !== false;
    const payload = {
